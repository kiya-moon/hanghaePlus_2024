...
public interface UserJpaRepository extends JpaRepository<User, Long> {
    ...
    // @Modifying
    // @Transactional
    // @Query("UPDATE User u SET u.balance = u.balance + :amount WHERE u.id = :userId AND u.version = :version")
    ...
    @Modifying
    @Query("UPDATE User u SET u.balance = :balance WHERE u.id = :userId AND u.version = :version")
