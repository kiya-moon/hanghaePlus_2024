...
public class ConcertService {
    ...
    public List<SeatEntity> getAvailableSeats(Long concertOptionId, Timestamp concertDate) {
        return seatRepository.findByConcertOptionIdAndConcertDate(concertOptionId, concertDate)
